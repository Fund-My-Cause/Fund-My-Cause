...
| [graphql.md](./graphql.md) | Generated GraphQL API schema and operations reference |
| [sdk-js/](./sdk-js/README.md) | Generated TypeScript reference for `@fund-my-cause/sdk` |

> `sdk-js/` is generated by TypeDoc from the SDK's JSDoc and committed to the
> repo. Do not edit those files by hand — change the JSDoc in `sdks/js/src/` and
> run `npm run docs` from `sdks/js`. See
> [the SDK README](../../sdks/js/README.md#regenerating-the-reference).
